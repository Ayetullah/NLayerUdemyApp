...
namespace Nlayer.Repository.Migrations
{
    ...
    [Migration("20221208232147_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NLayer.Core.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 12, 9, 2, 21, 47, 442, DateTimeKind.Local).AddTicks(9298),
                            Name = "Kalem1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 12, 9, 2, 21, 47, 442, DateTimeKind.Local).AddTicks(9310),
                            Name = "Kalem2",
                            Price = 200m,
                            Stock = 40
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2022, 12, 9, 2, 21, 47, 442, DateTimeKind.Local).AddTicks(9312),
                            Name = "Kitap2",
                            Price = 50m,
                            Stock = 40
                        });
            ...
            modelBuilder.Entity("NLayer.Core.Entities.ProductFeature", b =>
                {
                    b.HasOne("NLayer.Core.Entities.Category", null)
                        .WithMany("Products")
                        .HasForeignKey("CategoryId");
